...
export const ui = {
  ru: {
    ...
    'app.bittogether_desc': 'Приложение для совместной работы, обмена и координации внутри bit-экосистемы.',
  ...
  en: {
    ...
    'app.bittogether': 'bit Together',
    'app.bittogether_desc': 'An app for collaboration, sharing, and coordination inside the bit ecosystem.',
    'app.bitlauncher': 'bit Launcher',
